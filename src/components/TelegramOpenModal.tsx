...
export const TelegramOpenModal = () => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogContent
        className="bg-[#1a1a2e] border-white/10 max-w-sm mx-auto rounded-2xl"
        hideClose
      >
        ...
        <div className="flex flex-col gap-3 mt-2">
          <button
            onClick={handleOpen}
            className="w-full py-3.5 rounded-xl font-bold text-white transition-all duration-300 hover:brightness-110 active:scale-95"
            style={{
          ...
          <a
            ...
            className="text-center text-white/50 hover:text-white/70 text-sm transition-colors py-2"
          >
