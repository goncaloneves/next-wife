            ...
            <div className="absolute top-4 left-4 right-4 z-20 flex justify-between items-center pointer-events-none">
              {!isAppView ? (
                <button
                  ...
                  className="bg-black/20 backdrop-blur-md text-white/90 p-2.5 rounded-full border border-white/15 hover:bg-black/35 transition-all hover:scale-105 pointer-events-auto"
              ...
              <div 
                className="flex items-center bg-black/20 backdrop-blur-md rounded-full border border-white/15 pointer-events-auto"
                onPointerDownCapture={(e) => e.stopPropagation()} 
