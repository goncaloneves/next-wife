...
- **Telegram Mini App Support:** Integrated with Telegram WebApp SDK for proper safe area handling, viewport management, and automatic app expansion. Uses `safeAreaChanged` and `contentSafeAreaChanged` events for dynamic inset handling.
